...
public class CommonController {
    ...
    public Result add(@RequestBody User user){
        ...
        switch (user.getUserCharacter()) {
            case "Admin":
                adminService.save(new Admin(user.getUserName()));
                break;
            case "Courier":
                courierService.save(new Courier(user.getUserName(), user.getUserContact(), "true"));
                break;
            case "Customer":
                customerService.save(new Customer(user.getUserName(), user.getUserContact(), user.getUserAddress()));
                break;
            case "Manager":
                managerService.save(new Manager(user.getUserName(), user.getUserContact(), user.getUserAddress()));
                break;
            case "Supplier":
                supplierService.save(new Supplier(user.getUserName(), user.getUserContact(), user.getUserAddress()));
                break;
            default:
