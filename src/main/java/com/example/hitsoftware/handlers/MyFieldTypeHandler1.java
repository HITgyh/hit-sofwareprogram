...
public class MyFieldTypeHandler1 extends AbstractJsonTypeHandler<Object> {
    private static final Logger log = LoggerFactory.getLogger(JacksonTypeHandler.class);
    private static ObjectMapper objectMapper = new ObjectMapper();

    public MyFieldTypeHandler1(Class<?> type) {
    ...
    protected Object parse(String json) {
        try {
            ...
            return getObjectMapper().readValue(json, new TypeReference<Supplier>(){});
